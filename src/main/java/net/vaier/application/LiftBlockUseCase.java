 ...
 * often their own address blocked from a network Vaier does not know is theirs.
 *
 ...
 * @throws net.vaier.domain.BlockNotLiftedException if the block could not be lifted — never silence
 */
