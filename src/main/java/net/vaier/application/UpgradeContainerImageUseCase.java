...
/**
 * Upgrade one container to the newer image its registry now serves — the verb Vaier's update-available
 ...
 * stream as a settled container-upgrade event, carrying the sentence to show.
 */
public interface UpgradeContainerImageUseCase {

    /**
     * Upgrade the container named {@code containerName} on the machine {@code machineId}, and return at
     ...
     * @throws net.vaier.domain.ConflictException       when the container's upgrade eligibility refuses it,
     ...
     */
    void upgradeContainerImage(MachineId machineId, String containerName);
}
