 ...
 * @param readying what Vaier did about a missing grant — the detached install it launched, or the script it
...
public record BackupAsRootOutcome(BackupJob job, boolean granted, boolean changed, ReadyingOutcome readying) {
     ...
     * The install is detached, which is precisely why the flag does not move here: Vaier cannot yet say the
