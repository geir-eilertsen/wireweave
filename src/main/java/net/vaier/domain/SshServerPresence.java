...
/**
 * Vaier's last-known belief about whether an SSH server is listening on a machine at all —
 ...
 *
 * <p>{@link #UNKNOWN} — Vaier has never observed this machine's SSH port, or last observed it
