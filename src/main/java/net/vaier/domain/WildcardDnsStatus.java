...
/**
 * What Vaier found when it checked the operator's single {@code *.<domain>} record at boot.
 *
...
public enum WildcardDnsStatus {
    ...
    /** The verdict in the operator's words — never the enum's name, which is Vaier's. */
