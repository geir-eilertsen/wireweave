...
/**
 * Vaier asked CrowdSec to lift a block and could not tell that it had (#329 Slice 3c).
 *
 * <p>The deliberate opposite of {@link net.vaier.domain.port.ForDetectingIntrusions}'s contract, where a
