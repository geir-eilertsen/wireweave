...
/**
 * Whether the kits the fleet is holding still say what Vaier knows.
 *
 ...
 * surface. So the question has to be one Vaier asks itself, on a timer, without being told.
 *
 ...
 * {@link VaierConfig#withSurvivalKitPassphrase(String)} forgetting the fingerprint, which lands here as
