 ...
 * compose labels at all, and Vaier then does not know how it was started.
 *
 ...
 * anything else at all yields no coordinates. Vaier would rather know nothing about a container than
...
public record ComposeCoordinates(
    ...
    /**
     * The coordinates a container's labels state, or empty when it has none Vaier will act on — either
