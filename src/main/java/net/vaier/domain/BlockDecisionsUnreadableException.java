...
/**
 * Vaier asked CrowdSec who it is currently keeping out and could not find out (#329 Slice 3).
 *
 ...
 * operator's screen — the single most reassuring thing Vaier can say — and saying it because the read failed
 * is worse than saying nothing at all.
 *
 * <p>Deliberately <em>not</em> thrown on
 * {@link net.vaier.domain.port.ForDetectingIntrusions#getActiveDecisionsOrEmpty()}, whose silence the
 ...
 *
 * <p>Surfaces as {@code 502} — the failure is on the far side of Vaier, in the engine that owns the bans —
