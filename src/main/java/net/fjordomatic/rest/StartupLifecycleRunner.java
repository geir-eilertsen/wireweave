...
import net.fjordomatic.domain.Lifecycle;
...
/**
 * Fjord's boot sequence, run once the Spring context is up: verify the wildcard DNS record, bring up
...
public class StartupLifecycleRunner {
    ...
    public void handle(ApplicationReadyEvent event) {
        if (!setupStateHolder.isConfigured()) {
            log.info("Fjord is not configured. Set VAIER_DOMAIN in .env, create one DNS record "
