...
/**
 * The Clipboard's engine: a cross-machine copy is an SFTP read from the source relayed through Fjord's own
 * JVM to an SFTP write on the destination (#321, slice 2). Fjord sits at the VPN hub and is the only node
 ...
 * history. A Fjord restart simply loses in-flight transfers (acceptable for V1).
 *
