...
public class SettingsRestController {
    ...
    private final UpdateFjordUseCase updateFjordUseCase;
    ...
    public SettingsRestController(GetAppSettingsUseCase getAppSettingsUseCase,
                                  ...
                                  UpdateFjordUseCase updateFjordUseCase) {
        ...
        this.updateFjordUseCase = updateFjordUseCase;
    }
    ...
    /**
     * The deployed Fjord version, surfaced so the operator always sees which build is running. It doubles as
    ...
    /**
     * Whether a newer Fjord image is being served, and how the last self-update went. Both are reads: the
    ...
    /**
     * Replace Fjord with the newer image. Answers as soon as the host has taken the work — it cannot answer
    ...
    public ResponseEntity<UpdateResponse> update() {
        SelfUpdateStatus started = updateFjordUseCase.updateSelf();
     ...
     * since a rolled-back Fjord is a running Fjord and looks perfectly healthy.
     *
