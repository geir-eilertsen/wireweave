...
public class SecurityRestController {
     ...
     * takes effect from CrowdSec's next restart, which Fjord deliberately does not trigger — see
    ...
    /**
     * Stop trusting one address. It is not blocked by this — Fjord never blocks anyone — it simply goes back
     * to being judged on its behaviour, and it leaves CrowdSec's whitelist at CrowdSec's next restart, which
     * Fjord still does not trigger. Untrusting an address that is not in the list succeeds: see
    ...
    /**
     * Where the people Fjord lets in come from — one entry per place, for the map's green dots. The other
