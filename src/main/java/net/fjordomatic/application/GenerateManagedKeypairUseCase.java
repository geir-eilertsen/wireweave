...
/**
 * Mint a managed keypair for a machine: Fjord generates an ed25519 keypair, keeps the private half in
 ...
 * private half is created inside Fjord and never leaves it.
 */
public interface GenerateManagedKeypairUseCase {
     ...
     *
     * <p><strong>Destructive.</strong> Whatever login Fjord held for this machine is gone afterwards, and
