...
/**
 * Adopt a {@link net.fjordomatic.domain.DiscoveredLanMachine} the LAN scanner (issue #246) found into a
...
public interface AdoptDiscoveredMachineUseCase {
     ...
     *
     * @throws net.fjordomatic.domain.NotFoundException when no discovered machine at {@code ipAddress} is in
