...
import net.fjordomatic.application.CaptureViewerIdentityUseCase;
...
import net.fjordomatic.domain.AccessRoster;
...
import net.fjordomatic.domain.port.ForPersistingServiceAccessRules;
...
public class UserService implements
    ...
    private boolean isConsoleHost(String host) {
        ...
        return new FjordHostnames(domain).fjordServerFqdn().equalsIgnoreCase(host);
    }
