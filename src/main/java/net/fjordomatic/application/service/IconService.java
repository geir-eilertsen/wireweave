...
import net.fjordomatic.application.GetIconUseCase;
import net.fjordomatic.domain.Icon;
import net.fjordomatic.domain.IconResolution;
...
public class IconService implements GetIconUseCase {
    ...
    public Optional<Icon> getIcon(String host, String pathPrefix) {
        ...
        // address, because Fjord holds no oauth2 cookie — and only the origin has the app's own
