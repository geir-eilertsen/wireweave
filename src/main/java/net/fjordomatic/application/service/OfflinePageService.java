...
import net.fjordomatic.application.GetOfflinePageUseCase;
import net.fjordomatic.config.ConfigResolver;
import net.fjordomatic.domain.GatewayError;
...
public class OfflinePageService implements GetOfflinePageUseCase {
    ...
    private String renderHtml(GatewayError error, String serviceHost, String dashboardUrl) {
        ...
        return """
            ...
            <title>%TITLE% &middot; Fjord-O-Matic</title>
            ...
            <style>
            :root{--bg:#1e1e1e;--bg-card:#2d2d30;--border:#3c3c3c;--text:#d4d4d4;--text-muted:#858585;--accent:#4fc3f7;--accent-hover:#81d4fa;--brand-o:#39ff14;}
            *{margin:0;padding:0;box-sizing:border-box;}
            ...
            .brand-o{color:var(--brand-o);text-shadow:0 0 6px rgba(57,255,20,0.55);}
            ...
            <span>Fjord<span class="brand-o">-O-</span>Matic</span>
            </div>
