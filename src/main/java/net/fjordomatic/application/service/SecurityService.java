...
import net.fjordomatic.domain.port.ForWritingCrowdSecWhitelist;
 ...
 *
 * <p>It also owns the other side of the same coin: the {@link AccessSource}s, the places Fjord's own
...
public class SecurityService implements RefreshTrustedNetworksUseCase, GetTrustedNetworksUseCase,
    ...
    public void trustAddress(String sourceIp) {
        ...
        // Trusting alone would leave it blocked until the next CrowdSec restart (PRD §6.26), which Fjord
    ...
    /**
     * One effect, unlike its counterpart above: the decision is forgotten, and nobody is blocked. Fjord
