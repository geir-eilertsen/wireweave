...
import net.fjordomatic.domain.MountedArchive;
...
import net.fjordomatic.domain.ViewableFile;
...
import net.fjordomatic.domain.port.ForMountingArchives;
import net.fjordomatic.domain.port.ForReadingProtectedPaths;
...
/**
 * The Explorer domain service — one file tree spanning the fleet. Fjord sits at the VPN hub and is the
 ...
 * the directory over SFTP. The path arrives from the browser, so it is normalised <em>before</em> Fjord
...
public class ExplorerService
     ...
     * with one decision on top that is not the service's: {@link ViewableFile} says whether Fjord will hand
