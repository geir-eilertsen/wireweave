...
import net.fjordomatic.application.Passphrases;
...
public class BackupService implements
     ...
     * the machine has no job yet, and always with a backend-generated passphrase — Fjord never takes a
