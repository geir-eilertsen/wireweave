...
public final class PublishingConstants {
    ...
    /**
     * The infrastructure subdomains Fjord publishes for itself — the web UI, OAuth2 proxy, and Dex
    ...
    /**
     * Whether {@code fqdn} is one of Fjord's mandatory infrastructure hostnames — exactly
