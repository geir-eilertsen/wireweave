...
public interface GetServerLocationUseCase {
    ...
    /**
     * Static metadata about the Fjord server itself: where it is geographically, and the LAN/VPC
     ...
     * is present: the Map tab places a marker only when lat/lon are non-null; the Fjord-server
