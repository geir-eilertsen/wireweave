...
public interface DeleteFileUseCase {
     ...
     * @throws net.fjordomatic.domain.CannotDeleteSftpRootException when {@code path} is the machine's SFTP root
     * @throws net.fjordomatic.domain.PathOutsideSftpRootException when {@code path} is above the machine's SFTP root
     * @throws net.fjordomatic.domain.NotFoundException when no machine has that id, or the path is not there
     * @throws net.fjordomatic.domain.PermissionDeniedException when the SSH user may not delete the path
     */
