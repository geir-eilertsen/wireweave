 ...
 *
 * <p>Distinct from the LAN discovery sweep ({@link ScanLanUseCase}): this inspects the one
 * host the operator already named — a targeted, non-intrusive port probe, not a fan-out across a CIDR.
 * It never throws for the ordinary "couldn't reach it" outcome: an address
