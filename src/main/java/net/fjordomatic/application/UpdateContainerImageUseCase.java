...
/**
 * Update one container to the newer image its registry now serves — the verb Fjord's update-available
...
public interface UpdateContainerImageUseCase {
     ...
     *
     * @throws net.fjordomatic.domain.NotFoundException       when that machine has no container of that name
     * @throws net.fjordomatic.domain.ConflictException       when the container's update eligibility refuses it,
     *                                                  carrying the plain reason
     * @throws net.fjordomatic.domain.NoHostCredentialException when Fjord holds no SSH credential for the machine
     */
