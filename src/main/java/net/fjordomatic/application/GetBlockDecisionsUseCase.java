 ...
 * {@link net.fjordomatic.domain.BlockDecisionsUnreadableException}: this read feeds a screen where an empty list
 * reads as an all-clear, so it takes
 * {@link net.fjordomatic.domain.port.ForDetectingIntrusions#getActiveDecisionsOrFail()} and never the sweep's
 * silent read.
 */
