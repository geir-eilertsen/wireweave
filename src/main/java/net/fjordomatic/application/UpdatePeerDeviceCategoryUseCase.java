...
public interface UpdatePeerDeviceCategoryUseCase {
     ...
     * {@link net.fjordomatic.domain.DeviceCategory} name, otherwise {@link IllegalArgumentException} is
     * thrown (surfaced as 400). Throws {@link net.fjordomatic.domain.PeerNotFoundException} if no peer
     * has that id.
     */
