 ...
 * want Fjord to agree — immediately, not in up to 24 hours. Until this existed, the yellow mark lingered on an
 ...
 *
 * <p><b>This checks; it never pulls.</b> Fjord is read-only about containers — it has no endpoint to pull an
 * image or restart anything, and this opens none. What it acts on is Fjord's own knowledge, which is exactly
