 ...
 * a relay peer's id, or {@code LanAnchor.FJORD_SERVER_NAME} for the Fjord server's own LAN. The
...
public interface ScanLanAnchorUseCase {
     ...
     *
     * @throws net.fjordomatic.domain.NotFoundException when no scannable LAN carries {@code anchorKey}
     */
