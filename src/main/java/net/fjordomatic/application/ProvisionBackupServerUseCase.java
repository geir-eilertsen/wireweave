...
public interface ProvisionBackupServerUseCase {
    ...
    /**
     * Provision the named {@link net.fjordomatic.domain.BackupServer} by launching its bootstrap setup script on
     ...
     * the caller should poll {@link #provisionStatus}; {@code scriptOnly} when Fjord could not run it itself
     ...
     *
     * <p>{@code stagedScriptPath} is the absolute on-host path Fjord wrote the setup script to when it could
