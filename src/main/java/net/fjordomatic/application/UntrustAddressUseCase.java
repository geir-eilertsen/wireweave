 ...
 *
 * <p><b>It blocks nobody.</b> Fjord never blocks an address — CrowdSec's own scenarios decide that — so
 ...
 * restarts (PRD §6.26), and Fjord deliberately does not restart it — bouncing the engine that guards the
