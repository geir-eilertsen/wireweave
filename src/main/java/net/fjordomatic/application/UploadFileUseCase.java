...
public interface UploadFileUseCase {
     ...
     * @throws net.fjordomatic.domain.ConflictException when the name is already taken and no replacement was asked
     *                                            for, or when a folder wears the name (which no replacement
     *                                            settles)
     * @throws net.fjordomatic.domain.PathOutsideSftpRootException when the destination is above the machine's SFTP root
     * @throws net.fjordomatic.domain.NotFoundException when no machine has that id, or the directory is not there
     * @throws net.fjordomatic.domain.PermissionDeniedException when the SSH user may not write into the directory
     */
