...
/**
 * Trust a backup client host's SSH key on a {@link net.fjordomatic.domain.BackupServer}, so borg — which runs
...
public interface AuthorizeBackupClientUseCase {
     ...
     * exception — Fjord never writes junk into {@code authorized_keys}.
     */
     ...
     * already present and the append was a no-op; {@code hostKeyPinned} when Fjord could read the server's
