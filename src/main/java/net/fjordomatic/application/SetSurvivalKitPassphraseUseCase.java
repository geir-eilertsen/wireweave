 ...
 * no Fjord left to ask. Fjord stores it too (in the credential vault), because a passphrase Fjord does not
 * hold is a kit Fjord cannot rewrite, and a kit that stops being rewritten is exactly the stale sheet this
