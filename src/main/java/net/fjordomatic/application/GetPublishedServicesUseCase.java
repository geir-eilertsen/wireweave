...
import net.fjordomatic.domain.ReverseProxyRoute.ServiceLocation;
...
public interface GetPublishedServicesUseCase {
    ...
    record PublishedServiceUco(
        ...
        private static String legacyAuthMode(boolean authenticated) {
            return (authenticated ? net.fjordomatic.domain.AuthMode.SOCIAL : net.fjordomatic.domain.AuthMode.NONE).wireValue();
        }
        public PublishedServiceUco(String name, String dnsAddress, String hostAddress,
            ...
            this(name, name, null, "", null, ServiceLocation.FJORD_SERVER, state == State.OK,
        ...
        public PublishedServiceUco(String name, String dnsAddress, String hostAddress,
            ...
            this(name, name, null, "", null,
                isLanService ? ServiceLocation.LAN_SERVICE : ServiceLocation.FJORD_SERVER,
                state == State.OK,
                dnsAddress, hostAddress, hostPort, state, authenticated,
