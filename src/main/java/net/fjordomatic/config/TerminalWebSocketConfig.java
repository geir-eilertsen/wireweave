...
import net.fjordomatic.rest.TerminalWebSocketHandler;
 ...
 * machine name is pulled from the path in the handler (it may contain spaces, e.g. "Fjord server").
 *
 * <p>The upgrade is restricted to an explicit origin allowlist — the real Fjord origin
...
public class TerminalWebSocketConfig implements WebSocketConfigurer {
     ...
     * the Fjord origin rather than falling back to allowing all.
     */
