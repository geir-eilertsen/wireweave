 ...
 *       against Fjord's access store ({@code vaier-authz}).</li>
 * </ul>
 *
...
public enum AuthMode {
    ...
    /**
     * Whether {@code middlewareName} names one of Fjord's authentication middlewares — exact
