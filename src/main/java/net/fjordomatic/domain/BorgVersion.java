 ...
 *
 * <p>{@link #isSupported()} is a business predicate on the entity: Fjord's nightly chain ends in
...
public record BorgVersion(int major, int minor, int patch) {
    ...
    /**
     * Whether this borg is new enough for Fjord's fleet-backup chain. The nightly run ends in
