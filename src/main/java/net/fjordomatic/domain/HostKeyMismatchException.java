...
/**
 * Thrown when a machine presents an SSH host key whose fingerprint differs from the one Fjord pinned
 * on first use (TOFU). Fjord refuses the connection rather than silently trusting the new key — the
