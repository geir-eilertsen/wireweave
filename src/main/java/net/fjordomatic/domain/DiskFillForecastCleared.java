...
public record DiskFillForecastCleared(String machineName, String mountPoint, int currentPercent) {
    ...
    public String clearedSubject() {
        return "[Fjord-O-Matic] " + machineName + " " + mountPoint + " fill forecast cleared";
    }

    /**
     * Body for the all-clear email. {@code baseDomain} builds the Fjord UI link, and when it is null or
