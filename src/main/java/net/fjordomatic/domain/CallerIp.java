 ...
 * when the immediate connection came from inside the trusted proxy CIDR — Fjord's own Traefik. From
 ...
 *
 * <p><b>The leftmost hop is only trustworthy because Traefik strips the header.</b> Fjord sets no
...
public record CallerIp(String value) {
     ...
     * than being named. Fjord's stack is IPv4 throughout — one wildcard A record, an IPv4 tunnel — so that
