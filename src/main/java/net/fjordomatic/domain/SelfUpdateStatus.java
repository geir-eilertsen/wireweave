...
public record SelfUpdateStatus(String runId, SelfUpdateStatus.Outcome outcome, String at, String detail) {
    ...
    public enum Outcome {
        ...
        UPGRADED,
        /** It did not answer, so the previously running image was put back. Fjord is up — on the old build. */
        ROLLED_BACK,
    ...
    /**
     * Whether this outcome is something the operator needs to hear about. A rollback counts even though Fjord
