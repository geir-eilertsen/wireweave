 ...
 * manual-add counterpart of the scanner's per-host {@link DiscoveredLanMachine}. Fjord resolves what
 ...
 * @param routedVia  the relay peer (or the Fjord server) the probe was routed through, or {@code null}
 */
