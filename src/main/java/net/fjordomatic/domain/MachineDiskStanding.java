 ...
 * filesystem — and then thrown the readings away. So disk pressure was a thing Fjord knew and only ever
 ...
 * neither does one Fjord has not reached yet. That is the point of {@link #of} returning an
...
public record MachineDiskStanding(MachineId machineId, String worstMountPoint, int worstUsedPercent,
     ...
     * missing credential or a refused SSH tells you nothing new about its disks, only that Fjord could not
