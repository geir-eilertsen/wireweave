 ...
 * </pre>
 *
 * <p><b>And when it cannot be learnt, it is not guessed.</b> Two homes that do not line up mean Fjord does not
...
public record SftpRoot(String prefix) {
     ...
     * line up and Fjord must not invent a mapping.
     *
    ...
    /** A home is usable only if it is an absolute path; anything else tells Fjord nothing about this machine. */
