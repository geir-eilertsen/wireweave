...
/**
 * The single pinned borg-server image Fjord stands up when it provisions a {@link BackupServer}, mirroring
...
public final class BorgServerImage {
     ...
     * probed: a Fjord-managed server's client key is a <em>restricted, forced-command</em> key
    ...
    /** The borg version a Fjord-managed server runs, derived from the {@link #EXPECTED} pin (see {@link #BORG_VERSION}). */
