 ...
 *
 * <p>The conversation is deliberately this narrow. Fjord is read-only about containers — it never pulls, never
...
public interface ForResolvingRegistryDigest {
     ...
     * what they asked for, delivered at the precise moment they are testing whether Fjord can be trusted.
     *
