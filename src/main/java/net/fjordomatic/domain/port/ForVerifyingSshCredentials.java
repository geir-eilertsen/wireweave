...
public interface ForVerifyingSshCredentials {
     ...
     *
     * @throws net.fjordomatic.domain.SshConnectException when the transport fails (host unreachable/refused)
     * @throws net.fjordomatic.domain.SshAuthException    when the host is reached but the credential is rejected
     */
