...
public interface ForUpdatingPeerConfigurations {
     ...
     * {@link net.fjordomatic.domain.DeviceCategory} name; a null or blank value clears the override, after
    ...
    /**
     * Sets a peer's SSH-access override — whether Fjord offers SSH (credential control now, web
