 ...
 * a standing is what Fjord last saw on a machine, not a record of anything, so it is held in memory and a
...
public interface ForHoldingMachineDiskStandings {
    ...
    /** Every standing Fjord currently holds, in no particular order. */
     ...
     * deleted while Fjord was running does not leave its last disk reading behind forever.
     */
