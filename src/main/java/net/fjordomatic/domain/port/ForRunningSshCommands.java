 ...
 * captured output is capped, so a hung or chatty command can neither hang nor OOM Fjord.
 */
public interface ForRunningSshCommands {
     ...
     * bound for the probes and one-line reads that make up almost every remote command Fjord runs.
     */
