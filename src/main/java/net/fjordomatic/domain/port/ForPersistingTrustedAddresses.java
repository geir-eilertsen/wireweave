 ...
 * {@code CrowdSecWhitelistFileAdapter} rewrites it wholesale from {@link net.fjordomatic.domain.TrustedNetworks}
...
public interface ForPersistingTrustedAddresses {
     ...
     * {@link net.fjordomatic.domain.TrustedNetworks} — the VPN subnet, the Docker bridge, every relay's LAN — are
