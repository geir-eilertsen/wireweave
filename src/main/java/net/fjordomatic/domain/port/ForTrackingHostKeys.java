...
/**
 * Driven port for Fjord's trust-on-first-use store of SSH host-key fingerprints, keyed by {@link MachineId}. The first successful connect pins a machine's fingerprint; later connects compare against it
