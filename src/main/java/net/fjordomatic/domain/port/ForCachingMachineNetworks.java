...
/**
 * Driven port for Fjord's current belief about each machine's networks — the sibling of
...
public interface ForCachingMachineNetworks {
    ...
    /**
     * What Fjord last read off {@code machineId} — {@link MachineNetworks#unknown()} when it has never
