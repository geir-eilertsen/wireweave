...
public interface ForGettingPeerConfigurations {
    ...
    record PeerConfiguration(
        ...
        /**
         * The category Fjord shows for this peer: the operator's {@link #deviceCategory() override}
        ...
        /**
         * Whether Fjord offers SSH for this peer: the {@link #sshAccess() override} when set, else the
