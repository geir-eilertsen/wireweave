...
/**
 * Driven port for persisting {@link DiskPressureState} — which filesystem Fjord has already alerted admins
 * about, and at what {@link net.fjordomatic.domain.DiskPressureBand band}.
 *
 ...
 * Persisting it is what makes "the first time Fjord has ever seen this disk in trouble" a statement about
