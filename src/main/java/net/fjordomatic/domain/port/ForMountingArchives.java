...
/**
 * Driven port for mounting a machine's past — a borg {@link net.fjordomatic.domain.Archive} — as a read-only
...
public interface ForMountingArchives {
     ...
     * @throws net.fjordomatic.domain.NotFoundException when no machine bears the name
     */
     ...
     * idle lifecycle and gets swept. The registry does not survive a Fjord restart, so a {@code borg mount}
