 ...
 * 2026-07-23 a setup script pasted into the wrong terminal routed the Fjord staging server's own subnet
 ...
 * <ul>
 *   <li>{@link #wouldBlackhole(String, String)} — the Java predicate, asked before Fjord ever
 ...
 *       generated {@link SetupScriptGuard setup script} so it is also enforced on a host Fjord is not
 ...
 * from its own CIDR. The host at risk is the one adding {@code ip route <cidr> dev wg0}: the Fjord server
...
public final class UplinkGuard {
     ...
     * {@link Cidr#contains(String)}, expressed for a machine Fjord is not connected to.
     */
