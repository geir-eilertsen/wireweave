...
/**
 * The SSH user's home directory on a machine, as the <em>exec</em> channel reports it: how Fjord asks
 * ({@link #PROBE_COMMAND}) and how the answer is read ({@link #in}).
 *
 * <p>Two parts of Fjord need this same fact. The backup work dir has resolved it since the backups shipped
 ...
 * one home; Fjord has been bitten before by several code paths quietly disagreeing about a machine, and a
