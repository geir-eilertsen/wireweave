...
public final class PeerSetupScript {
    ...
    public static String generate(String peerId, String vpnIp, String serverUrl, String serverPort,
        ...
        sb.append("\n");
        sb.append("# Fjord peer setup script for: ").append(peerId).append("\n");
        ...
        sb.append("\n");
        // Refuse the wrong machine before a single line mutates it. Fjord cannot know this host's
        // address yet — the peer has no tunnel until this script builds one — so the guard leans on
        // the Fjord-server probes, the machine stamp, and the CIDRs the config about to be installed
        ...
        sb.append("}\n");
        sb.append("\n");
        sb.append("echo \"=== Fjord Peer Setup: $PEER_NAME ===\"\n");
        sb.append("echo \"\"\n");
        sb.append("\n");
        ...
        if (lanCidr != null && !lanCidr.isBlank()) {
            ...
            sb.append("[Unit]\n");
            sb.append("Description=Fjord WireGuard relay iptables rules\n");
