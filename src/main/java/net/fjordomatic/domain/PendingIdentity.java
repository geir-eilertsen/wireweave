...
public record PendingIdentity(String email) {
    ...
    public String notificationSubject() {
        return "[Fjord-O-Matic] New access request awaiting approval";
    }
    ...
    public String notificationBody(String baseDomain) {
        ...
        body.append("Until an admin approves it, this identity cannot reach Fjord or any published service.\n");
