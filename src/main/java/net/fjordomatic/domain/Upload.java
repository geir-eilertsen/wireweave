 ...
 * {@link net.fjordomatic.domain.port.ForBrowsingRemoteFiles#download download}, and the whole of it: what the
...
public record Upload(MachineId machineId, String directory, String filename, boolean overwrite) {
     ...
     * a failure and travels on, because "Fjord could not look" must never be reported as "the name is free".
     */
