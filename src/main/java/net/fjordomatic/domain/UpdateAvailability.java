...
/**
 * What Fjord has decided about one container's image: it is current, a newer image is being served for the
 * very tag it runs, or Fjord <b>cannot tell</b>.
 *
...
public enum UpdateAvailability {
    ...
    /** Fjord could not resolve one of the two digests. Not outdated, not current — unknowable. */
    UNKNOWN,
