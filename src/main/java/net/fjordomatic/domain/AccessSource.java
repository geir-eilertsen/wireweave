...
/**
 * One place allowed accesses to Fjord-gated services have come from — the green dot on the map, and the
 * mirror image of a {@link BlockDecision}: who got in, rather than who was kept out. Everything Fjord gates
...
public record AccessSource(String city, String country, Double latitude, Double longitude,
    ...
    /** Whether this place has gone quiet for longer than Fjord remembers a place for. */
