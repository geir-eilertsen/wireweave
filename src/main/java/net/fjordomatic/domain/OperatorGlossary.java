 ...
 * glossary of the terms an operator meets in the Fjord UI, grouped and ordered the way the page
 * shows them.
 *
    ...
    public static List<ConceptGroup> groups() {
        return List.of(
            new ConceptGroup("Machines", List.of(
                Concept.of("Machine",
                    "Any computer Fjord knows about — a VPN peer or a LAN server.",
                ...
                Concept.of("Server peer",
                    ...
                    "Pick this kind for a host you'll publish services from or turn into a relay; it stays on the VPN subnet (split tunnel) rather than routing all its traffic through Fjord."),
                Concept.of("LAN server",
                    "A machine on your local network that Fjord reaches directly, without the VPN.",
                    "Register it when the host already shares your LAN and a tunnel would be overkill."),
                Concept.of("Relay peer",
                    "A server peer with a LAN CIDR set, so Fjord routes that whole local network through its tunnel to reach the machines behind it.",
                ...
                Concept.of("LAN address",
                    "The local IP address Fjord uses to reach a LAN server.",
                    "If it's wrong, Fjord can't reach the machine or its services."),
                Concept.of("LAN CIDR",
                    "The address range of your local network, written as an IP/prefix (e.g. 192.168.1.0/24).",
                    "Fjord uses it to tell which discovered machines are genuinely on your LAN."),
                Concept.of("Reissue",
            ...
            new ConceptGroup("Services", List.of(
                ...
                Concept.of("Ignored service",
                    "A discovered service you've told Fjord to stop offering for publishing.",
            ...
            new ConceptGroup("DNS & access", List.of(
                Concept.of("Wildcard DNS",
                    ...
                    "Make it and DNS is done — Fjord never has to touch it again."),
                Concept.of("Wildcard DNS report",
                    "What Fjord found when it checked that wildcard record at startup.",
                ...
                Concept.of("Forward-auth",
                    ...
                    "It's how a service gets put behind Fjord's single sign-on."),
                ...
                Concept.of("Public host",
                    "The internet-facing hostname that resolves to your Fjord server.",
            ...
            new ConceptGroup("Status & discovery", List.of(
                ...
                Concept.of("Last seen",
                    "The most recent time Fjord had any contact with a machine.",
                ...
                Concept.of("Reachability check",
                    "A probe Fjord runs to see whether a machine or service actually responds.",
            ...
            new ConceptGroup("Backups", List.of(
                Concept.of("Backup job",
                    "Fjord's standing instruction to back up one machine's chosen folders every night.",
                ...
                Concept.of("Back up as root",
                    "Reading every file on a machine when Fjord copies it, including files that belong to "
                        + "other users — container volumes, databases, other people's home folders. Fjord "
                    ...
                    "Turn it on when a backup came back incomplete: it's the one setting that decides "
                        ...
                        + "worth knowing — the machine has to let Fjord's login run the backup program as "
                        + "root without a password, which makes that login as powerful as root there. Fjord "
                        + "grants it for the backup program alone, and only when you say yes."),
                Concept.of("Backup repository",
                    "The store on the backup server that holds one machine's archives. Fjord makes exactly "
                        + "one per machine, names it after the machine and generates the passphrase that "
                        + "unlocks it — you never create or name one.",
                    "You won't meet this word anywhere else in Fjord: every screen says whose backups a "
            ...
            new ConceptGroup("Launchpad", List.of(
                ...
                Concept.of("Version endpoint",
                    "A service URL Fjord polls to read the version a service reports.",
