 ...
 *
 * <p><b>Back up as root.</b> Fjord runs borg over SSH as the machine's credential user (e.g. {@code ubuntu}),
...
public record BackupJob(
    ...
    /**
     * Whether Fjord-owned nightly scheduling should fire this job right now — the "should this job run"
