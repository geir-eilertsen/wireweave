 ...
 * decision that drives WireGuard client/server config — a device category never changes how Fjord
 ...
 *
 * <p>The category is normally auto-detected from the signals Fjord already has (the machine name,
