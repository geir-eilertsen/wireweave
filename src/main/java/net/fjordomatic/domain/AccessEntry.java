...
public class AccessEntry {
    ...
    /** The Dex connector ids Fjord recognises as identity providers. */
    ...
    /** A Fjord administrator — may administer the console and reach every service. */
    public boolean isAdmin() {
        return role == Role.ADMIN;
    }

    /** Whether this identity may reach the Fjord console. Admins only. */
