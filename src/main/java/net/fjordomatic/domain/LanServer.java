...
/**
 * A non-WireGuard machine Fjord knows about, persisted in {@code lan-servers.yml}.
 *
...
public record LanServer(String name, String lanAddress, boolean runsDocker, Integer dockerPort,
    ...
    /**
     * Whether Fjord offers SSH for this LAN server: the {@link #sshAccessOverride() override} when
    ...
    /**
     * The category Fjord shows for this LAN server: the operator's {@link #deviceCategory() override}
