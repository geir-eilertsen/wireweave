 ...
 * deliberately distinct from the §6.7/#153 "Backup snapshot" (an export of Fjord's own config), which
 ...
 *
 * @param name       the Fjord-facing identity of this repository, unique within the store
