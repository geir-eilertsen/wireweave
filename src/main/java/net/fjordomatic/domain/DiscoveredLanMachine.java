...
/**
 * A host the LAN scanner (issue #246) found responding on a relay peer's LAN (or the Fjord
 ...
 *                     {@link LanAnchor#FJORD_SERVER_NAME} for the Fjord server's own LAN
...
public record DiscoveredLanMachine(
    ...
    /**
     * Whether this host answered on the SSH port (22). Only then can Fjord hold an SSH login for it,
