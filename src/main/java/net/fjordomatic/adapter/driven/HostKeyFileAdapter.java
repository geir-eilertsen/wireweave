...
public class HostKeyFileAdapter implements ForTrackingHostKeys {
    ...
    @Override
    public synchronized Optional<String> getFingerprint(net.fjordomatic.domain.MachineId machineId) {
        Object value = readAll().get(machineId.value());
        return value == null ? Optional.empty() : Optional.of(value.toString());
    }

    @Override
    public synchronized void pin(net.fjordomatic.domain.MachineId machineId, String fingerprint) {
    ...
    @Override
    public synchronized void clear(net.fjordomatic.domain.MachineId machineId) {
        Map<String, Object> all = new TreeMap<>(readAll());
