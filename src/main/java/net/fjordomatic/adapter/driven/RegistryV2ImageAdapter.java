 ...
 * body would be paid for on every image. The token asks for {@code :pull} on exactly one repository: Fjord is
 ...
 * Failures are deliberately <em>not</em> cached: caching "unknown" would let one blip blind Fjord for a day.
 *
