 ...
 *
 * <p>Reimplementing OpenSSL's envelope in Java rather than shelling out to the binary is deliberate: Fjord
 ...
 * creates — that Fjord's bytes and OpenSSL's expectations never drift apart — is discharged by a test that
