...
import net.fjordomatic.domain.Cidr;
...
/**
 * Sweeps a LAN CIDR from inside the Fjord WireGuard container — the one host that already routes to
...
public class LanScanAdapter implements ForScanningLan {
    ...
    /** Service ports probed per host; the open set feeds {@link net.fjordomatic.domain.LanMachineRole}. */
