 ...
 * Fjord could not read is not a machine with no networks, and the difference matters, because the second
 * would be offered as evidence.
 *
 * <p>It pins the host key on first use like every other SSH-reaching path. A machine that Fjord only ever
