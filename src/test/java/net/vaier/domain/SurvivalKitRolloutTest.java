...
class SurvivalKitRolloutTest {
    ...
    @Test
    void everyChosenMachineGetsTheKit_andSoDoesTheVaierServer() {
    ...
    void aRolloutThatReachedNoRemoteMachineAtAllSaysSo_becauseTheLocalCopyAloneIsNotAKit() {
        // A copy that dies with Vaier is not redundancy. If every remote write failed, the fleet is back to
        ...
        assertThat(result.survivesLossOfVaier()).isFalse();
