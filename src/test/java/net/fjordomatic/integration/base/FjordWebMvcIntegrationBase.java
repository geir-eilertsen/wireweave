package net.fjordomatic.integration.base;

import com.fasterxml.jackson.databind.ObjectMapper;
import net.fjordomatic.application.*;
...
public abstract class FjordWebMvcIntegrationBase {
    ...
    @MockBean
    protected net.fjordomatic.application.UpdatePeerDeviceCategoryUseCase updatePeerDeviceCategoryUseCase;
    ...
    @MockBean
    protected net.fjordomatic.application.GetSelfUpdateStatusUseCase getSelfUpdateStatusUseCase;

    @MockBean
    protected net.fjordomatic.application.UpdateFjordUseCase updateFjordUseCase;
    ...
    @MockBean
    protected DiscoverFjordServerContainersUseCase discoverFjordServerContainersUseCase;
    ...
    @MockBean
    protected net.fjordomatic.application.UpdateLanServerDeviceCategoryUseCase updateLanServerDeviceCategoryUseCase;
    ...
    @MockBean
    protected net.fjordomatic.application.ProbeLanHostUseCase probeLanHostUseCase;
    ...
    @MockBean
    protected GetFjordServerUseCase getFjordServerUseCase;
    ...
    @MockBean
    protected net.fjordomatic.application.ScanLanAnchorUseCase scanLanAnchorUseCase;

    @MockBean
    protected net.fjordomatic.application.ListScannableLansUseCase listScannableLansUseCase;
    ...
    @MockBean
    protected net.fjordomatic.application.VerifySshCredentialUseCase verifySshCredentialUseCase;
    ...
    @MockBean
    protected net.fjordomatic.application.ProtectMachinePathsUseCase protectMachinePathsUseCase;
