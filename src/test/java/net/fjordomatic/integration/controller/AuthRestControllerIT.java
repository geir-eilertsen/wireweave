...
class AuthRestControllerIT extends FjordWebMvcIntegrationBase {
    ...
    void getMe_reportsIsAdminFromTheResolvedAccessEntry() throws Exception {
        ...
        when(captureViewerIdentityUseCase.captureIdentity("alice@example.com", null, null, null)).thenReturn(
            java.util.Optional.of(net.fjordomatic.domain.AccessEntry.builder()
                .email("alice@example.com").role(net.fjordomatic.domain.Role.ADMIN).build()));
