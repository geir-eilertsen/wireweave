...
import net.fjordomatic.application.CreatePeerUseCase.CreatedPeerUco;
...
class VpnPeerControllerIT extends FjordWebMvcIntegrationBase {
    ...
    void deletePeer_returns404WhenNotFound() throws Exception {
        doThrow(new net.fjordomatic.domain.PeerNotFoundException("Peer not found: peer1"))
    ...
    void reissuePeer_returns200WithFreshConfigAndReopensTheOneShotGate() throws Exception {
        var reissued = new net.fjordomatic.application.ReissuePeerConfigUseCase.ReissuedPeerUco(
    ...
    void reissuePeer_returns404WhenPeerNotFound() throws Exception {
        when(reissuePeerConfigUseCase.reissuePeerConfig("ghost"))
                .thenThrow(new net.fjordomatic.domain.PeerNotFoundException("Peer not found: ghost"));
