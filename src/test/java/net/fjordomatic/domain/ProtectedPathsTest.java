...
class ProtectedPathsTest {
    ...
    @Test
    void aGlobExcludeNeverDemotesAFolder_becauseFjordCannotTellWhatItBitesInto() {
        // '*.tmp' is a borg fnmatch pattern, not a path: Fjord cannot say which files it removes, so it can
