 ...
 * anything, and it deliberately bypasses the digest cache — so it is the one path in Fjord that can turn an
...
class UpdateCheckFloorTest {
    ...
    @Test
    void aRefusedCheckReportsWhenFjordLastReallyLooked() {
