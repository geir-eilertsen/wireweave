...
/**
 * Whether the kits out on the fleet still say what Fjord now knows.
 *
 ...
 * flaw — so the question "is what they are holding still true?" has to be one Fjord asks itself.
 *
