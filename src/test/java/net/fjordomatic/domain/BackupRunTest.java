...
class BackupRunTest {
    ...
    void failureSubjectAndBodyRenderJobMachineExitAndLink() {
        ...
        assertThat(failed.failureSubject(MACHINE))
            .isEqualTo("[Fjord-O-Matic] Backup failed: colina-home on Colina 27");
    ...
    void recoverySubjectAndBodyRenderTheAllClear() {
        ...
        assertThat(ok.recoverySubject(MACHINE))
            .isEqualTo("[Fjord-O-Matic] Backup recovered: colina-home on Colina 27");
    ...
    // skipped every one of them, exited 1, and Fjord recorded the run as a non-failure — so nobody was told
    ...
    void anIncompleteRunTellsAdminsPlainlyThatDataWasNotBackedUp() {
        ...
        assertThat(run.failureSubject(MACHINE))
            .isEqualTo("[Fjord-O-Matic] Backup incomplete: colina-home on Colina 27");
    ...
    void aGenuinelyFailedRunKeepsItsOwnSubject() {
        ...
        assertThat(failed.failureSubject(MACHINE)).isEqualTo("[Fjord-O-Matic] Backup failed: colina-home on Colina 27");
    ...
    void aRunRefusedForAMissingBorgClient_knowsItCanBeFixedByReadyingTheHost() {
        ...
        // fine — borg simply is not installed there yet, and Fjord can install it. Whether a failure means
