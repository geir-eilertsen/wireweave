...
class SelfUpdateStatusTest {
    ...
    void aRollbackIsTrouble_becauseTheNewBuildDidNotComeUp() {
        // Fjord is running again, so nothing looks broken — which is exactly why this has to be said out
    ...
    void theComposeProjectIsReadOffTheContainer_notConfigured() {
        ...
        // type it into an env var would be asking them for something Fjord can see. Docker stamps both the
    ...
    void aContainerComposeDidNotStart_hasNoProjectToUpdateIn() {
        ...
        // up` that would bring it back, so an update would take Fjord down and leave it down.
