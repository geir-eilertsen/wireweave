...
class BorgClientSetupScriptTest {
    ...
    // --- The passwordless-sudo probe: whether Fjord can install borg itself over SSH ---
    ...
    void detachedLaunch_base64DecodesTheScriptThenNohupsItUnderSudoAndEchoesStarted() {
        ...
        // Unlike the server helper, the install needs root and Fjord SSHes as a non-root user, so the
