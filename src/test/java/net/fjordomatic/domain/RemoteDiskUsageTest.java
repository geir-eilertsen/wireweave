...
class RemoteDiskUsageTest {
     ...
     * is the 11.6 TB volume that holds every borg backup, 39% used with 7.1 TB free — and Fjord could not
    ...
    //
    // The bug: DF_COMMAND was `df -P /`, so Fjord watched the root filesystem and only the root filesystem.
    ...
    void parseList_seesTheVolumeThatMatters_withItsSizeAndItsFreeSpace() {
        // The whole point of #325: /volume1 is 39% used with 7.1 TB free, and Fjord reported 88% for this
    ...
    @Test
    void judge_aMutedFilesystem_isSilent_soFjordSaysNothingAboutItAtAll() {
    ...
    // nowhere near full, and rightly stopped trusting Fjord. The mount and the size have to be in the words.
