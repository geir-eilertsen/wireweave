 ...
 * wrong terminal and reconfigured a Fjord server: it took the stack down, deleted the server's
...
class PeerSetupScriptTest {
    ...
    void generate_guardsBeforeTouchingAnythingOnTheHost() {
        ...
        // Every one of these ran on the Fjord server before anyone could react. The guard has to sit
