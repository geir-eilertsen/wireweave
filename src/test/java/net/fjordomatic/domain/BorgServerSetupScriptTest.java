...
class BorgServerSetupScriptTest {
    ...
    @Test
    void generate_chownsAuthorizedKeysToTheOwnerSoFjordCanAppendClientKeys() {
        // Fjord appends client public keys to authorized_keys over SSH *as the owner*. The script runs as
    ...
    void generate_derivesBorgUidAndGidFromTheOwnerAtRunTime_neverHardcodes1000() {
        ...
        // borg container chowns its data to the exact SSH user Fjord writes authorized_keys as.
    ...
    void generate_publishesTheHostKeysWhereTheSshOwnerCanReadThem() {
        ...
        // chowns it to the SSH owner and makes it 644 so Fjord can read them over SSH and pin them on clients.
        String s = BorgServerSetupScript.generate(server(), "geir");
