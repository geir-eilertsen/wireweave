 ...
 * head, re-answer every time the fleet changes, and would get wrong quietly. Fjord picks, and says why.
 *
...
class SurvivalKitHostsTest {
    ...
    /** A fleet Fjord cannot place on the map: separation then rests on the relay rule alone. */
    ...
    @Test
    void theFjordServerNeverHoldsACopy() {
        ...
        assertThat(skipReasonFor(selection, VAIER)).containsIgnoringCase("Fjord");
    }

    @Test
    void clientMachinesAreNotEligible_becauseAKitOnSomethingCarriedAroundIsNotAKit() {
        // Fjord rewrites kits when passphrases change. A machine that is in a bag at that moment keeps a kit
    ...
    @Test
    void aFleetFjordCannotPlaceOnTheMapStillGetsItsCopiesSpreadAcrossRelays() {
    ...
    @Test
    void aMachineFjordCannotReachOverSshIsNotEligible_becauseItCouldNeverBeGivenAKit() {
