...
class PeerSnapshotTest {
    ...
    void notificationSubject_reflectsConnectedState() {
        ...
        assertThat(connected.notificationSubject()).isEqualTo("[Fjord-O-Matic] file-server is now connected");
        assertThat(disconnected.notificationSubject()).isEqualTo("[Fjord-O-Matic] file-server is now disconnected");
    }

    @Test
    void notificationBody_includesMachineDetailsAndFjordUiLink() {
    ...
    void notificationBody_omitsHandshakeLanAndLinkWhenAbsent() {
        ...
        assertThat(body).doesNotContain("Fjord UI");
    }
}
