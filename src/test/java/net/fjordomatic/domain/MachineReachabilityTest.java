...
class MachineReachabilityTest {
    ...
    @Test
    void fjordServerIsAlwaysReachable() {
        Machine server = Machine.fjordServer(MachineId.generate(), null);
    ...
    void peerReachableWhenHandshakeFresh() {
        ...
        Machine connected = new Machine(MachineId.generate(), "alice", MachineType.UBUNTU_SERVER, "pk", "10.13.13.2/32",
