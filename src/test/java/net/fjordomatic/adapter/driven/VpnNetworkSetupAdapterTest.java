...
import net.fjordomatic.adapter.driven.VpnNetworkSetupAdapter.HostnameResolver;
import net.fjordomatic.adapter.driven.VpnNetworkSetupAdapter.ProcessResult;
import net.fjordomatic.adapter.driven.VpnNetworkSetupAdapter.ProcessRunner;
