...
class FjordServerSshAddressAdapterTest {
    ...
    void parsesDefaultGatewayFromProcNetRoute() {
        ...
        assertThat(FjordServerSshAddressAdapter.parseDefaultGateway(procNetRoute)).contains("172.17.0.1");
    }
    ...
    void returnsEmptyWhenNoDefaultRoute() {
        ...
        assertThat(FjordServerSshAddressAdapter.parseDefaultGateway(procNetRoute)).isEmpty();
    }

    @Test
    void envOverrideWins() {
        FjordServerSshAddressAdapter adapter = new FjordServerSshAddressAdapter("10.0.0.5");
    ...
    void parsesAnotherGateway() {
        ...
        assertThat(FjordServerSshAddressAdapter.parseDefaultGateway(line)).contains("10.0.0.1");
    }

    // Sanity: the helper is the tested seam; the adapter's env/gateway wiring is exercised above.
    @Test
    void parseHandlesEmpty() {
        assertThat(FjordServerSshAddressAdapter.parseDefaultGateway("")).isEqualTo(Optional.empty());
    }
}
