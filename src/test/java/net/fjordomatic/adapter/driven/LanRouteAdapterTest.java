...
import net.fjordomatic.adapter.driven.LanRouteAdapter.HostnameResolver;
import net.fjordomatic.adapter.driven.LanRouteAdapter.ProcessResult;
import net.fjordomatic.adapter.driven.LanRouteAdapter.ProcessRunner;
