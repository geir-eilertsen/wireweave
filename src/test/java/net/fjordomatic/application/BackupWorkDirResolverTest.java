...
class BackupWorkDirResolverTest {
    ...
    /** The stable test id for the machine named {@code name} — production never derives one from a name. */
    private static MachineId id(String name) {
    ...
    @Test
    void resolvesHomeIntoDotFjordBackup() {
