...
class GetLaunchpadServicesTest {
    ...
    void getLaunchpadServices_excludesMandatoryInfrastructureRouters() {
        ...
        // Authelia is decommissioned: only the Fjord console router is mandatory infrastructure,
    ...
    void getLaunchpadServices_excludesTheOauth2AndDexInfrastructureRouters() {
        ...
        // oauth2 (sign-in gateway) and dex (OIDC broker) are Fjord infrastructure, so they never
    ...
    @Test
    void getLaunchpadServices_fjordServerService_carriesBackingContainerImage() {
        setupOneRoute("app.example.com", "grafana", 3000);
        setupEmptyVpnClients();
        when(discoverFjordServerContainers.discover()).thenReturn(
