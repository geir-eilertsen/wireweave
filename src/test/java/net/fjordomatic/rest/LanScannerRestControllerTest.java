...
import net.fjordomatic.application.GetDiscoveredLanMachinesUseCase;
import net.fjordomatic.application.GetDiscoveredLanMachinesUseCase.LanScanSnapshot;
import net.fjordomatic.application.GetDiscoveredLanMachinesUseCase.ScanStatus;
import net.fjordomatic.application.IgnoreLanMachineUseCase;
import net.fjordomatic.application.ListScannableLansUseCase;
import net.fjordomatic.application.ListScannableLansUseCase.ScannableLan;
import net.fjordomatic.application.ScanLanAnchorUseCase;
import net.fjordomatic.application.ScanLanUseCase;
import net.fjordomatic.application.UnignoreLanMachineUseCase;
import net.fjordomatic.application.VerifySshCredentialUseCase;
import net.fjordomatic.application.AdoptDiscoveredMachineUseCase.AdoptionOutcome;
...
import net.fjordomatic.rest.LanScannerRestController.AdoptRequest;
import net.fjordomatic.rest.LanScannerRestController.AdoptResponse;
import net.fjordomatic.rest.LanScannerRestController.DiscoveredMachineDto;
import net.fjordomatic.rest.LanScannerRestController.IgnoreRequest;
import net.fjordomatic.rest.LanScannerRestController.LanScanResponse;
import net.fjordomatic.rest.LanScannerRestController.SshCredentialBlock;
import net.fjordomatic.rest.LanScannerRestController.SshCredentialTestRequest;
...
class LanScannerRestControllerTest {
    ...
    void getLansReturnsTheScannableLans() {
        when(listScannableLansUseCase.scannableLans()).thenReturn(List.of(
            ...
            new ScannableLan("Fjord server", "Fjord server", "172.31.0.0/16")));
        ...
        assertThat(body).containsExactly(
            ...
            new LanScannerRestController.ScannableLanDto("Fjord server", "Fjord server", "172.31.0.0/16"));
    }
