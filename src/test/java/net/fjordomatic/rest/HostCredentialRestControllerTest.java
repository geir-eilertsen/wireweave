...
class HostCredentialRestControllerTest {
    ...
    void put_savesCredentialBuiltFromPathAndBody_returnsRedactedView() {
        ...
        ArgumentCaptor<net.fjordomatic.domain.SshCredentialDraft> captor =
            ArgumentCaptor.forClass(net.fjordomatic.domain.SshCredentialDraft.class);
        verify(saveHostCredentialUseCase).saveHostCredential(eq(mid("nas")), captor.capture());
        net.fjordomatic.domain.SshCredentialDraft saved = captor.getValue();
