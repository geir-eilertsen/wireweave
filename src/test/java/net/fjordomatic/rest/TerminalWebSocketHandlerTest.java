...
class TerminalWebSocketHandlerTest {
    ...
    void machineFromPath_readsTheIdentitySegment() {
        ...
        assertThat(TerminalWebSocketHandler.machineFromPath(
            URI.create("wss://host/machines/" + mid("Fjord server") + "/terminal")))
            .isEqualTo(mid("Fjord server").value());
        assertThat(TerminalWebSocketHandler.machineFromPath(
    ...
    void droppedSocket_doesNotEndTheShell() {
        ...
        // This is the whole promise of a persistent shell: a dropped tunnel, a closed laptop or a Fjord
