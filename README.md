...
| **Explorer** | One tree for the whole fleet — browse files, containers and services, select and transfer across machines, step back in time through backup archives, and see live who's blocked at the edge and which addresses you've trusted. See [`docs/EXPLORER.md`](docs/EXPLORER.md). |
